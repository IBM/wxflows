# Using watsonx.ai Flows Engine with LangGraph (Python)
...
> You can use any of the [supported chat models](https://python.langchain.com/docs/integrations/chat/).
...
To run the script you need to install the necessary dependencies:
